        ...
        <>
            <div className="form-group row">
                ...
                <div className= {props.inputStyle} >
                    <input type={props.type} name={props.name} value={props.value} className= { props.loginField ? "form-control shadow" : "form-control"} id="inputEmail3" onChange={props.onChange} onBlur={props.onBlur} placeholder={props.placeholder}/>
                </div>
            </div>
            {
                props.error  &&
